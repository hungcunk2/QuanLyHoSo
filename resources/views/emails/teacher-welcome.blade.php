...
<head>
    ...
    <title>Chào mừng giáo viên mới</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        <p>Xin chào <strong>{{ $teacher->ho_ten }}</strong>,</p>
        ...
        <div class="info-box">
            ...
            <div class="info-item">
                <span class="info-label">Mã số giáo viên:</span> {{ $teacher->msgv }}
            </div>
            <div class="info-item">
                <span class="info-label">Họ và tên:</span> {{ $teacher->ho_ten }}
            </div>
            @if($teacher->email)
            <div class="info-item">
                <span class="info-label">Email:</span> {{ $teacher->email }}
            </div>
            @endif
            @if($teacher->chuyen_mon)
            <div class="info-item">
                <span class="info-label">Chuyên môn:</span> {{ $teacher->chuyen_mon }}
            </div>
            @endif
        </div>
        ...
        <div class="login-box">
            ...
            <div class="login-credentials">
                <div class="info-item">
                    <span class="info-label">Tài khoản (Username):</span> <strong>{{ $teacher->msgv }}</strong>
                </div>
                <div class="info-item">
        ...
        <p>Vui lòng đăng nhập vào hệ thống để cập nhật các thông tin còn lại như số điện thoại, ngày sinh, địa chỉ.</p>
