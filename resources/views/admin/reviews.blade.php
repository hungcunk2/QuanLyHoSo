...
<div class="card">
    <div class="card-body">
        <div class="admin-toolbar admin-toolbar-list">
            <form id="quick-action-form" class="form-disabled quick-action-form admin-toolbar-list__actions">
                @csrf
        ...
        <div class="table-responsive mt-3 admin-table-wrap">
            <table id="reviewsTable" class="table table-striped border w-100 mb-0">
                <thead>
                    <tr>
                        <th width="50">
